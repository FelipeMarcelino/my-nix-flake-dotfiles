...
in {
	...
	config = {
	   ...
	   keybindings = {
	    ...
	    "${mod}+Control+k" = "exec --no-startup-id wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+";
	    "${mod}+Control+j" = " exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-";
	    "${mod}+Control+space" = "exec --no-startup-id wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle";
